...
4. **Document Construction**: The handler builds a rich textual representation of the item.
   * *Example*: `"Name: Cơm gà nướng. Description: Cơm gà sốt teriyaki đậm vị. Tags: gà, cơm. Nutrition: 660 calories, 55g protein, 45g carbs. Status: available."*
...
1. **Query Vectorization**: The user types *"high protein food"*. The backend API converts this exact string into a 768-dimensional vector using the same embedding model.
...
1. User Query: *"Highly rated high protein chicken near me"*
