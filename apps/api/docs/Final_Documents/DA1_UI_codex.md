...
- Mô tả sử dụng và xử lý sự kiện: Người dùng nhấn "Get Started" để mở màn hình đăng ký hoặc "Sign In" để đăng nhập. Nếu chọn Google, hệ thống gọi dịch vụ xác thực bên ngoài; thành công thì tạo phiên đăng nhập và chuyển vào app, thất bại thì hiển thị thông báo lỗi và giữ nguyên màn hình.
...
- Mô tả sử dụng và xử lý sự kiện: Người dùng nhập email và mật khẩu rồi nhấn "Sign In". Hệ thống kiểm tra định dạng, gọi API đăng nhập, lưu token khi thành công và chuyển về màn hình chính; nếu sai thông tin hoặc lỗi mạng, hệ thống hiển thị lỗi và cho phép nhập lại.
...
- Mô tả sử dụng và xử lý sự kiện: Người dùng nhập thông tin bắt buộc, đánh dấu đồng ý điều khoản và nhấn "Continue". Hệ thống kiểm tra dữ liệu, gọi API đăng ký; thành công thì tạo tài khoản và chuyển đến app hoặc đăng nhập, thất bại thì hiển thị nguyên nhân như email đã tồn tại hoặc mật khẩu không hợp lệ.
...
- Mô tả sử dụng và xử lý sự kiện: Người dùng chọn địa chỉ hoặc tìm kiếm món ăn/nhà hàng. Hệ thống tải danh sách theo vị trí, lọc theo từ khóa hoặc danh mục, mở chi tiết nhà hàng khi chọn card; nếu giỏ hàng có món, thanh giỏ hàng nổi cho phép đi nhanh đến màn hình giỏ hàng.
...
- Mô tả sử dụng và xử lý sự kiện: Người dùng chọn một địa chỉ trong danh sách hoặc yêu cầu dùng vị trí hiện tại. Hệ thống lưu địa chỉ được chọn vào trạng thái khách hàng, dùng địa chỉ đó cho tìm kiếm nhà hàng và checkout; nếu không lấy được vị trí, hệ thống thông báo lỗi quyền truy cập hoặc lỗi định vị.
...
- Mô tả sử dụng và xử lý sự kiện: Người dùng nhập hoặc chọn vị trí, bổ sung chi tiết địa chỉ và nhấn lưu. Hệ thống kiểm tra dữ liệu, lưu vào danh sách địa chỉ của tài khoản; nếu thiếu tên hoặc địa chỉ, màn hình hiển thị lỗi tại trường tương ứng.
...
- Mô tả sử dụng và xử lý sự kiện: Người dùng cuộn menu, lọc theo danh mục và chọn món. Nếu món có tùy chọn, hệ thống mở màn hình chi tiết món; nếu món có thể thêm nhanh, hệ thống cập nhật giỏ hàng và hiển thị thanh giỏ hàng. Khi nhà hàng đóng cửa hoặc món hết hàng, thao tác thêm món bị vô hiệu hóa.
...
- Mô tả sử dụng và xử lý sự kiện: Người dùng chọn các tùy chọn bắt buộc, chỉnh số lượng và nhấn thêm vào giỏ. Hệ thống kiểm tra modifier, tính lại giá theo tùy chọn; nếu hợp lệ thì thêm hoặc cập nhật dòng giỏ hàng, nếu thiếu lựa chọn bắt buộc thì hiển thị cảnh báo và không đóng màn hình.
...
- Mô tả sử dụng và xử lý sự kiện: Người dùng xem thông tin, tăng giảm số lượng hoặc chọn món liên quan. Khi nhấn thêm vào giỏ, hệ thống cập nhật giỏ hàng và phản hồi bằng thông báo; nếu món không còn khả dụng, button thêm giỏ bị khóa hoặc hiển thị lỗi.
...
- Mô tả sử dụng và xử lý sự kiện: Người dùng chỉnh số lượng hoặc xóa món khỏi giỏ. Hệ thống cập nhật tổng tiền ngay trên màn hình; nếu giỏ hàng còn món hợp lệ, button checkout được bật và chuyển sang luồng đặt hàng, nếu giỏ trống thì hiển thị trạng thái rỗng.
...
- Mô tả sử dụng và xử lý sự kiện: Người dùng kiểm tra thông tin và nhấn đặt hàng. Hệ thống xác thực địa chỉ, giỏ hàng, khuyến mãi và phương thức thanh toán; nếu hợp lệ thì tạo đơn và chuyển sang thanh toán hoặc trạng thái đơn hàng, nếu không hợp lệ thì hiển thị lỗi như địa chỉ ngoài vùng giao, món hết hàng hoặc mã ưu đãi không còn áp dụng.
...
- Mô tả sử dụng và xử lý sự kiện: Người dùng chọn địa chỉ và quay lại checkout. Hệ thống cập nhật địa chỉ giao hàng của đơn, tính lại phí giao hàng và thời gian dự kiến; nếu địa chỉ nằm ngoài vùng giao của nhà hàng, hệ thống cảnh báo và yêu cầu chọn địa chỉ khác.
...
- Mô tả sử dụng và xử lý sự kiện: Người dùng chọn một ưu đãi. Hệ thống kiểm tra nhà hàng, thời gian hiệu lực, giá trị đơn hàng và số lượt dùng; nếu đủ điều kiện thì áp dụng giảm giá vào checkout, nếu không đủ điều kiện thì giải thích điều kiện còn thiếu.
...
- Mô tả sử dụng và xử lý sự kiện: Người dùng chọn một phương thức thanh toán. Hệ thống lưu lựa chọn cho đơn hàng hiện tại hoặc làm mặc định; nếu chọn VNPay, sau khi đặt hàng hệ thống điều hướng sang luồng thanh toán trực tuyến, nếu chọn tiền mặt thì đơn được tạo theo phương thức COD.
...
- Mô tả sử dụng và xử lý sự kiện: Người dùng rà soát và nhấn "Place Order". Hệ thống khóa dữ liệu đơn tại thời điểm đặt, kiểm tra lại giá và khả dụng của món; thành công thì tạo đơn, thất bại thì thông báo lỗi và yêu cầu người dùng chỉnh sửa thông tin liên quan.
...
- Mô tả sử dụng và xử lý sự kiện: Sau khi người dùng quay lại từ VNPay, hệ thống đọc kết quả, kiểm tra trạng thái giao dịch và cập nhật đơn hàng. Nếu thanh toán thành công, người dùng có thể theo dõi đơn; nếu thất bại hoặc hết hạn, màn hình cung cấp thao tác thử lại hoặc quay về trang chủ.
...
- Mô tả sử dụng và xử lý sự kiện: Người dùng kéo để làm mới hoặc chọn một đơn. Hệ thống tải danh sách đơn của tài khoản hiện tại, hiển thị trạng thái mới nhất và điều hướng đến chi tiết hoặc theo dõi khi người dùng chọn đơn.
...
- Mô tả sử dụng và xử lý sự kiện: Người dùng mở đơn từ lịch sử. Hệ thống tải chi tiết đơn, hiển thị thông tin thanh toán và trạng thái; nếu đơn đang chờ thanh toán VNPay thì cho phép tiếp tục thanh toán, nếu đơn đã hoàn tất thì hiển thị thao tác đánh giá.
...
- Mô tả sử dụng và xử lý sự kiện: Hệ thống hiển thị các mốc như đã đặt, nhà hàng xác nhận, đang chuẩn bị, sẵn sàng, đã giao hoặc đã hủy. Khi trạng thái thay đổi từ backend, timeline được cập nhật; nếu đơn hoàn tất, màn hình mở lối vào đánh giá.
...
- Mô tả sử dụng và xử lý sự kiện: Người dùng chọn số sao, chọn tối đa các tag phù hợp và nhập bình luận tùy chọn. Hệ thống kiểm tra đơn có đủ điều kiện đánh giá không; thành công thì lưu review và cập nhật màn hình đơn hàng, thất bại thì hiển thị lỗi như đơn chưa hoàn tất hoặc đã đánh giá.
...
- Mô tả sử dụng và xử lý sự kiện: Người dùng mở hộp thư, kéo làm mới hoặc chọn một thông báo. Hệ thống đánh dấu đã đọc khi người dùng mở thông báo và điều hướng đến màn hình liên quan như đơn hàng, ưu đãi hoặc cài đặt; button "Mark all read" cập nhật toàn bộ trạng thái đã đọc.
...
- Mô tả sử dụng và xử lý sự kiện: Người dùng chọn từng mục để vào màn hình quản lý tương ứng. Khi nhấn đăng xuất, hệ thống hiển thị xác nhận; nếu đồng ý, hệ thống hủy token thông báo của thiết bị, xóa phiên đăng nhập và chuyển về luồng xác thực.
...
- Mô tả sử dụng và xử lý sự kiện: Người dùng chỉnh thông tin cho phép và nhấn lưu. Hệ thống kiểm tra dữ liệu, gửi yêu cầu cập nhật hồ sơ; thành công thì cập nhật thông tin hiển thị, thất bại thì giữ dữ liệu hiện tại và hiển thị lỗi.
...
- Mô tả sử dụng và xử lý sự kiện: Người dùng chọn phương thức mặc định và nhấn lưu. Hệ thống lưu lựa chọn vào hồ sơ hoặc trạng thái checkout; nếu phương thức chưa khả dụng, card được khóa và hiển thị thông tin chờ hỗ trợ.
...
- Mô tả sử dụng và xử lý sự kiện: Người dùng bật/tắt thông báo hoặc mở các mục thông tin. Hệ thống lưu cấu hình thông báo, đăng ký hoặc hủy đăng ký nhận push tương ứng; nếu thiết bị chưa cấp quyền, hệ thống yêu cầu quyền hoặc hiển thị hướng dẫn.
...
- Mô tả sử dụng và xử lý sự kiện: Người dùng đọc thông tin và nhấn CTA đăng ký hoặc đăng nhập. Hệ thống điều hướng đến màn hình đăng ký tài khoản đối tác hoặc đăng nhập; các anchor trong trang cuộn đến phần nội dung tương ứng.
...
- Mô tả sử dụng và xử lý sự kiện: Người dùng nhập email và mật khẩu, chọn ghi nhớ thiết bị nếu cần rồi nhấn đăng nhập. Hệ thống xác thực tài khoản và vai trò; thành công thì chuyển đến dashboard hoặc trang chờ phê duyệt, thất bại thì hiển thị lỗi và không tạo phiên.
...
- Mô tả sử dụng và xử lý sự kiện: Người dùng nhập thông tin đại diện và tạo tài khoản. Hệ thống kiểm tra email, mật khẩu, gọi API đăng ký; thành công thì chuyển sang màn hình đăng ký thông tin nhà hàng, thất bại thì hiển thị lỗi như email đã được sử dụng.
...
- Mô tả sử dụng và xử lý sự kiện: Người dùng nhập thông tin nhà hàng và yêu cầu định vị địa chỉ nếu cần. Hệ thống chuẩn hóa địa chỉ, lưu tọa độ và gửi hồ sơ; thành công thì chuyển đến trạng thái chờ duyệt, thất bại thì chỉ rõ trường chưa hợp lệ.
...
- Mô tả sử dụng và xử lý sự kiện: Sau khi gửi hồ sơ, hệ thống hiển thị trạng thái đang chờ. Người dùng có thể quay lại đăng nhập hoặc liên hệ hỗ trợ; khi admin phê duyệt, lần đăng nhập sau sẽ điều hướng vào dashboard.
...
- Mô tả sử dụng và xử lý sự kiện: Khi người dùng đăng nhập nhưng hồ sơ chưa active, hệ thống đưa đến màn hình này. Người dùng không thể mở các route vận hành; nếu đăng xuất, phiên bị xóa và quay lại màn hình đăng nhập.
...
- Mô tả sử dụng và xử lý sự kiện: Người dùng xem nhanh doanh thu, đơn hàng và cảnh báo. Khi bật/tắt cửa hàng, hệ thống cập nhật trạng thái nhận đơn; khi chọn một đơn, portal điều hướng đến chi tiết đơn để xử lý.
...
- Mô tả sử dụng và xử lý sự kiện: Nhà hàng xem đơn ở từng cột và kéo thả hoặc nhấn action để chuyển trạng thái. Hệ thống gọi API tương ứng; thành công thì card chuyển cột và khách hàng nhận cập nhật, thất bại thì hiển thị lỗi và hoàn nguyên thao tác.
...
- Mô tả sử dụng và xử lý sự kiện: Nhân viên mở đơn để xem món, ghi chú và thông tin thanh toán. Tùy trạng thái, hệ thống hiển thị action hợp lệ; khi người dùng xác nhận action, backend cập nhật trạng thái đơn và đồng bộ đến mobile khách hàng.
...
- Mô tả sử dụng và xử lý sự kiện: Người dùng lọc món, thêm danh mục, bật/tắt món hoặc mở form sửa. Hệ thống cập nhật trạng thái món tức thời; khi xóa món, hệ thống yêu cầu xác nhận để tránh mất dữ liệu ngoài ý muốn.
...
- Mô tả sử dụng và xử lý sự kiện: Người dùng nhập thông tin món và nhấn publish. Hệ thống kiểm tra dữ liệu bắt buộc, tải ảnh nếu có và tạo món mới; thành công thì điều hướng về quản lý menu, thất bại thì hiển thị lỗi tại form.
...
- Mô tả sử dụng và xử lý sự kiện: Người dùng mở món, chỉnh thông tin hoặc thêm modifier rồi lưu. Hệ thống cập nhật dữ liệu món và các lựa chọn liên quan; nếu modifier bắt buộc không có option hợp lệ, hệ thống báo lỗi để người dùng hoàn thiện.
...
- Mô tả sử dụng và xử lý sự kiện: Người dùng tạo hoặc sửa vùng giao hàng. Hệ thống lưu cấu hình vùng và dùng dữ liệu này để kiểm tra địa chỉ khách hàng trong checkout; nếu vùng bị tắt, địa chỉ thuộc vùng đó sẽ không được xem là khả dụng.
...
- Mô tả sử dụng và xử lý sự kiện: Người dùng chọn khoảng thời gian hoặc bật so sánh. Hệ thống tải lại số liệu, cập nhật biểu đồ và bảng; khi nhấn export, hệ thống tạo file báo cáo hoặc gọi API xuất dữ liệu.
...
- Mô tả sử dụng và xử lý sự kiện: Người dùng xem danh sách và thay đổi trạng thái khuyến mãi. Hệ thống kiểm tra quyền sở hữu nhà hàng, cập nhật trạng thái hoặc xóa khuyến mãi; nếu khuyến mãi đang chạy có ràng buộc, hệ thống cảnh báo trước khi thay đổi.
...
- Mô tả sử dụng và xử lý sự kiện: Người dùng nhập thông tin khuyến mãi và chọn lưu nháp hoặc phát hành. Hệ thống kiểm tra thời gian, giá trị giảm, giới hạn lượt dùng; thành công thì lưu dữ liệu và cập nhật danh sách khuyến mãi, thất bại thì hiển thị lỗi theo trường.
...
- Mô tả sử dụng và xử lý sự kiện: Người dùng chọn tab và cập nhật thông tin tương ứng. Hệ thống kiểm tra quyền, lưu thay đổi từng nhóm cấu hình; với thao tác nhạy cảm như đổi mật khẩu hoặc đăng xuất thiết bị, hệ thống yêu cầu xác nhận và cập nhật phiên đăng nhập.
...
- Mô tả sử dụng và xử lý sự kiện: Người dùng nhập thông tin và nhấn đăng nhập. Hệ thống xác thực tài khoản, kiểm tra vai trò admin; nếu hợp lệ thì chuyển vào dashboard, nếu không phải admin hoặc sai thông tin thì hiển thị lỗi và không cấp quyền.
...
- Mô tả sử dụng và xử lý sự kiện: Admin chọn khoảng thời gian để xem số liệu tổng quan. Hệ thống tải lại chỉ số và biểu đồ; khi admin chọn hồ sơ chờ duyệt hoặc đối tượng vận hành, màn hình điều hướng sang module quản lý tương ứng.
...
- Mô tả sử dụng và xử lý sự kiện: Admin tìm kiếm hoặc lọc nhà hàng, mở sheet để xem thông tin chi tiết. Khi approve, suspend hoặc delete, hệ thống yêu cầu xác nhận nếu cần, gọi API cập nhật trạng thái và làm mới bảng; kết quả thao tác được ghi nhận phục vụ kiểm soát quản trị.
...
- Mô tả sử dụng và xử lý sự kiện: Admin lọc đơn theo trạng thái, thanh toán hoặc từ khóa, rồi mở chi tiết để kiểm tra. Hệ thống hiển thị dữ liệu đơn, timeline, khách hàng và thanh toán; nếu có URL giao dịch VNPay, admin có thể mở để đối soát.
...
- Mô tả sử dụng và xử lý sự kiện: Admin tìm kiếm tài khoản và mở chi tiết. Khi đổi vai trò hoặc khóa tài khoản, hệ thống kiểm tra quyền admin, yêu cầu lý do nếu khóa, cập nhật tài khoản và làm mới danh sách; nếu thao tác không hợp lệ, hệ thống hiển thị lỗi.
...
- Mô tả sử dụng và xử lý sự kiện: Admin xem các chương trình hiện có và chọn thao tác quản trị. Hệ thống cập nhật trạng thái khuyến mãi, kiểm tra thời gian hiệu lực và phạm vi áp dụng; với thao tác hủy hoặc xóa, hệ thống yêu cầu xác nhận để tránh ảnh hưởng người dùng.
...
- Mô tả sử dụng và xử lý sự kiện: Admin mở một khuyến mãi để kiểm tra cấu hình và danh sách mã. Khi sinh mã, hệ thống tạo coupon theo số lượng/điều kiện; khi thu hồi, coupon không còn được áp dụng trong checkout và bảng được cập nhật lại.
...
- Mô tả sử dụng và xử lý sự kiện: Admin nhập cấu hình và chọn lưu nháp hoặc phát hành. Hệ thống kiểm tra điều kiện giảm giá, phạm vi áp dụng, lịch chạy và giới hạn sử dụng; thành công thì lưu khuyến mãi và cập nhật danh sách, thất bại thì hiển thị lỗi theo từng nhóm cấu hình.
...
- Mô tả sử dụng và xử lý sự kiện: Admin cập nhật hồ sơ hoặc đổi mật khẩu trong tab tương ứng. Hệ thống kiểm tra dữ liệu, lưu thay đổi hồ sơ; với đổi mật khẩu, hệ thống yêu cầu mật khẩu hiện tại và mật khẩu mới hợp lệ, sau đó có thể thu hồi các phiên đăng nhập khác để giảm rủi ro bảo mật.
